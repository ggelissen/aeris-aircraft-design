...
class WingParameters:
    ...
    def __init__(self, parent, W_TO: float = None, W_S: float = None):
        ...
        self.main_flaps = FlapGroup(spanwise_pos_frac_inbound=0.35, spanwise_pos_frac_outbound=0.75, flapwidth=0.1)
...
class EmpennageParameters:
    ...
    def __init__(self, l_f: float = None):
        ...
        self.V_h = 0.9 # 0.64 #estimation                             # V-Tail Volume Coefficient
        self.V_v = 0.08 # 0.07 #estimation                             # Horizontal Stabilizer Volume Coefficient
...
class WingSectionParameters:
    def __init__(self, parent):
        self.spars = {
            "Spar1": {"x_pos_frac": 0.2, "t_flange_1_mm": 3, "t_flange_2_mm": 3, "t_web_mm": 30, "flange_width_mm": 50, 'material_density_kgm3': parent.materials.material_density},
            "Spar2": {"x_pos_frac": 0.7, "t_flange_1_mm": 3, "t_flange_2_mm": 3, "t_web_mm": 30, "flange_width_mm": 50, 'material_density_kgm3': parent.materials.material_density},
        }
        self.num_spars = len(self.spars)
        self.stringers = {
            "Stringer1": {"top_or_bottom_side": "top" , "pos_along_airfoil_side": 0.02, "crosssectionalarea_mm2": 400 , 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer2": {"top_or_bottom_side": "top" , "pos_along_airfoil_side": 0.1, "crosssectionalarea_mm2": 400 , 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer3": {"top_or_bottom_side": "top" , "pos_along_airfoil_side": 0.25, "crosssectionalarea_mm2": 400 , 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer4": {"top_or_bottom_side": "top" , "pos_along_airfoil_side": 0.4, "crosssectionalarea_mm2": 400 , 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer5": {"top_or_bottom_side": "top" , "pos_along_airfoil_side": 0.5, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer6": {"top_or_bottom_side": "top" , "pos_along_airfoil_side": 0.6, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer7": {"top_or_bottom_side": "top", "pos_along_airfoil_side": 0.8, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer8": {"top_or_bottom_side": "bottom", "pos_along_airfoil_side": 0.02, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer9": {"top_or_bottom_side": "bottom", "pos_along_airfoil_side": 0.1, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer10": {"top_or_bottom_side": "bottom", "pos_along_airfoil_side": 0.25, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer11": {"top_or_bottom_side": "bottom", "pos_along_airfoil_side": 0.4, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer12": {"top_or_bottom_side": "bottom", "pos_along_airfoil_side": 0.5, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer13": {"top_or_bottom_side": "bottom", "pos_along_airfoil_side": 0.6, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
            "Stringer14": {"top_or_bottom_side": "bottom", "pos_along_airfoil_side": 0.8, "crosssectionalarea_mm2": 400, 'material_density_kgm3': parent.materials.material_density, 'area_moment_of_inertia_m4': 5e-9*3, 'K': 1.0},
        }
