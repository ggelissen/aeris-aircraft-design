...
def dutch_roll_eigenvalues(params: DesignParameters):
    ...
    A = 8*mub**2*KZ2
    B = -2*mub*(params.stability_aero.Cnr+2*KZ2*params.stability_aero.CYb)
    C = 4*mub*params.stability_aero.Cnb+params.stability_aero.CYb*params.stability_aero.Cnr
